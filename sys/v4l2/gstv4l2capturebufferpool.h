...
GstBufferPool * gst_v4l2_capture_buffer_pool_new     (GstV4l2Object *obj, GstCaps *caps);
void gst_v4l2_capture_buffer_pool_set_proxy_pool (GstV4l2CaptureBufferPool * pool,
                                                         GstBufferPool * proxy_pool);
void gst_v4l2_capture_buffer_pool_copy_at_threshold (GstV4l2CaptureBufferPool * pool,
                                                            gboolean copy);
G_END_DECLS
